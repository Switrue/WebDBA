...
namespace WebDBA.Models.DTOs.Workers
{
    public class CreateWorkerDto
    {
        ...
        [StringLength(6, ErrorMessage = "ID должен содержать не более 6 символов")]
        [RegularExpression(@"^[A-Z0-9]+$", ErrorMessage = "ID должен содержать только заглавные буквы и цифры")]
        [Display(Name = "ID")]
